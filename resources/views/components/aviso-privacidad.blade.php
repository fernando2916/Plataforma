<button type="button" class=" inline-flex items-center font-medium text-link-500 hover:text-link-700 dark:text-link-100 dark:hover:text-link-400 transition-colors duration-150 cursor-pointer disabled:opacity-50 disabled:pointer-events-none md:text-[.7rem]" aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-scale-animation-modal" data-hs-overlay="#hs-scale-animation-modal">
    Aviso de privacidad
  </button>
